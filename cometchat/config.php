...
define('COMET_ROOT',dirname(__FILE__).DIRECTORY_SEPARATOR);
...
$trayicon[] = array('home','首页','/','','','','','');
$trayicon[] = array('announcements','通告','modules/announcements/index.php','_popup','280','300','','1');
...
//$trayicon[] = array('share','分享本页','modules/share/index.php','_popup','340','50','','1');
$trayicon[] = array('chatrooms','讨论室','modules/chatrooms/index.php','_popup','500','300','','1');
//$trayicon[] = array('games','Single Player Games','modules/games/index.php','_popup','500','300','','1');
$trayicon[] = array('scrolltotop','转到顶部','javascript:jqcc.cometchat.scrollToTop();','','','','','');
...
//$plugins = array('handwrite','games','smilies','writeboard','whiteboard','filetransfer','chathistory','save','chattime','clearconversation','whiteboard');
$plugins = array('smilies','filetransfer','chathistory','save','chattime','clearconversation');
...
$crplugins = array('smilies','handwrite','chattime','chattime');
...
$bannedWords = array('asshole', 'fuck', 'bastard', 'bitch', 'suck','去死');
$bannedUserIDs = array();
$bannedMessage = '理性讨论, 请使用文明用语';
...
$cookiePrefix = 'simu_'; // Modify only if you have multiple CometChat instances on the same site
...
$minHeartbeat = '2000'; // Minimum poll-time in milliseconds (1 second = 1000 milliseconds)
